            ...
            for m in range(0, len(model_epochs), self.args.skip):
                for attack_config in attack_configs:
                    ...
                    if isinstance(attack_config, common.experiments.AttackWeightsConfig):
                        ...
                        attack_quantization = getattr(attack_config.attack, 'quantization', False)

                    # projection and quantization is set in interface
                    ...
                    if isinstance(attack_config, common.experiments.AttackWeightsConfig):
                        ...
                        attack_config.attack.quantization = attack_quantization
