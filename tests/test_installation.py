...
def check_datasets():
    ...
    try:
        dataset = common.datasets.Cifar100TrainSet()
        dataset = common.datasets.Cifar100TestSet()
        print('MNIST found.')
    except AssertionError as e:
        print('MNIST files not found.')
...
def check_cupy():
    ...
    import torch
    import common.cupy
    print('CuPy tools imported.')
    #except:
    #    print('Some problems with CuPy, try tests/test_cupy.py to debug!')
...
def check_cffi():
    try:
        ...
        import common.cffi
        print('If there were not compilation errors, CFFI modules should work.')
    except ImportError as e:
        print('Could not load CFFI or common.cffi.')
