...
class AdversarialWeightsEvaluation:
    """
    Evaluation on adversarial weights, i.e., weight perturbations.
    """
    ...
    def loss(self):
        ...
        # We use the torch implementation of cross-entropy to get the exact same results for evaluation as
        # during training.
