...
def raw_cifar100_dir():
    """
    Raw Cifar100 training directory.

    :return: fielpath
    :rtype: str
    """

    return data_file('Cifar100/', '')


def cifar100_train_images_file():
    """
    ...
    return data_file('Cifar100/train_images', HDF5_EXT)


def cifar100_test_images_file():
    """
    ...
    return data_file('Cifar100/test_images', HDF5_EXT)


def cifar100_train_labels_file():
    """
    Cifar100 train labels.

    :return: filepath
    :rtype: str
    """

    return data_file('Cifar100/train_labels', HDF5_EXT)


def cifar100_test_labels_file():
    """
    Cifar100 test labels.

    :return: filepath
    :rtype: str
    """

    return data_file('Cifar100/test_labels', HDF5_EXT)
